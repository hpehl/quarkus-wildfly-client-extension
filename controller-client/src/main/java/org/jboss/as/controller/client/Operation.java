...
/**
 * Encapsulates a detyped operation request passed in to the model controller, along with any attachments associated
 * with the request.
 *
...
public interface Operation extends OperationAttachments {
    ...
    class Factory {
        ...
        /**
         * Create a simple operation with stream attachments. The streams will not be {@link
         * OperationAttachments#isAutoCloseStreams() automatically closed} when operation execution is completed.
         *
         * @param operation   the DMR operation. Cannot be {@code null}
        ...
        /**
         * Create an operation using the given streams and be {@link OperationAttachments#isAutoCloseStreams()
         * auto-close streams} setting.
         *
         * @param operation        the DMR operation. Cannot be {@code null}
         * @param attachments      the stream attachments. Cannot be {@code null}
         * @param autoCloseStreams {@code true} if the attached streams should be automatically closed when operation
         *                         execution completes
         * @return the operation. Will not be {@code null}
         */
        public static Operation create(final ModelNode operation, final List<InputStream> attachments,

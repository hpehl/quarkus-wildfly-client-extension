...
/**
 * An {@link org.jboss.as.controller.client.OperationResponse} that proxies back to a remote server to read any attached
 * response streams.
 *
...
public class OperationResponseProxy implements OperationResponse {
    ...
    private OperationResponseProxy(final ModelNode responseNode, final ManagementChannelAssociation channelAssociation,
            final int batchId, final ModelNode streamHeader) {
    ...
    public static OperationResponseProxy create(final ModelNode responseNode,
            final ManagementChannelAssociation channelAssociation, final int batchId, final ModelNode streamHeader) {
    ...
    private static class ProxiedInputStream extends InputStream implements StreamEntry {
        ...
        ProxiedInputStream(final String uuid, final String mimeType,
        ...
        private synchronized void readInputStream() {
            ...
            final ManagementRequest<Void, Void> getISRequest = new AbstractManagementRequest<Void, Void>() {
                ...
                @Override
                protected void sendRequest(ActiveOperation.ResultHandler<Void> resultHandler,
                ...
                @Override
                public void handleRequest(DataInput input, ActiveOperation.ResultHandler<Void> resultHandler,
                        ManagementRequestContext<Void> context) throws IOException {
                    try {

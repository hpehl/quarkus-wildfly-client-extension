...
public interface ManagementRequestHandlerFactory {
    ...
    /**
     * Try to resolve the request handler for the given header. If an implementation is unable to resolve a handler
     * itself, it must complete this method by returning the result of {@code handlers.resolveNext()}.
     *
    ...
    /**
     * A chain of multiple request handler factories, also providing a hook for factories to create new active
     * operations or register the local process instance of a remotely initiated active operation.
     */
    interface RequestHandlerChain {
        ...
        /**
         * Create a new active operation, with a given operation-id obtained from an {@link
         * ManagementRequestHeader#getOperationId() incoming request's header}.
         *
        ...
        /**
         * Create a new active operation, with a given operation-idobtained from an {@link
         * ManagementRequestHeader#getOperationId() incoming request's header}.
         *
         * @param id         the operation-id
         * @param attachment the attachment

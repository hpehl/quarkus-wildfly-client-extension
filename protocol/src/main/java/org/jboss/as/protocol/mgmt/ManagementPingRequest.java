...
/**
 * {@link ManagementRequest} that sends a {@link ManagementProtocol#TYPE_PING} header. Note that this is distinct from
 * the top-level sending of {@link ManagementPingHeader} used by legacy (community 7.0.x) clients.
 *

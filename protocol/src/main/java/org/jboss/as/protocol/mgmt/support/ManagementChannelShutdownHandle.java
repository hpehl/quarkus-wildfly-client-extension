...
/**
 * A handle to a processor of management requests which can be used to coordinate a controlled shutdown of a processor that
 * allows active operations to complete before shutting down.
 * <p>
...
public interface ManagementChannelShutdownHandle {
     ...
     *
     * <p>
     * This method does not wait for previously submitted operations to be completed. Use {@link #awaitCompletion
     * awaitCompletion} to do that.
     * </p>
     */
    void shutdown();
